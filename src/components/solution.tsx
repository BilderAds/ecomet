        ...
        <div className="grid md:grid-cols-3 gap-6">
          {benefits.map((benefit) => (
            <Reveal key={benefit.title}>
              <div className="group relative h-full p-8 rounded-2xl bg-white/[0.03] border border-white/[0.06] hover:border-ecomet/30 hover:bg-white/[0.05] transition-all duration-500">
