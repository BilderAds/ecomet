  ...
  return (
    <section id="funktionen" className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature) => (
            <Reveal key={feature.title}>
              <div className="group h-full p-8 rounded-2xl bg-[#fafafa] border border-[#e5e5e5] hover:border-ecomet/30 hover:shadow-lg hover:shadow-ecomet/5 transition-all duration-500 hover:-translate-y-1">
        ...
        <Reveal className="flex flex-col items-center gap-4 mt-12">
          <a
